<template>
  <div>
    <div class="wrapper">
      <div class="container">
        <h1>ABOUT ME: CAMERON STEMMET</h1>
      </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <p>
                        ...
                        figuring out how electronic gadgets work. I am fascinated by how technology is going to shape
                        our future.
                    </p>
                </div>
            </div>
			...
			<div class="row">
				<div class="col-xl-8 mx-auto text-center">
					<div class="section-title">
						<h4>Timeline of my professional life</h4>
						<p>so far</p>
					</div>
				</div>
			</div>
                  ...
                  <ul class="timeline-list">
                     ...
                     <li>
                        <div class="timeline_content">
                           <span>2017-2019</span>
                           <h4>Cape Academy of Maths Science and Technology</h4>
                           <p>I spent the first 2 years of my high school at the Cape Academy of Maths, Science and
                        Technology. It is based out in Constania and instilled a great sense of hardwork within me.</p>
                        </div>
                     </li>
                     <!-- Single Experience -->
                     <li>
                        ...
                        <span>2019-2020</span>
                           ...
                           <p>I spent my third year of highschool at Windsor and believe that they helped me with my social
                        skills and teamwork. I also took this time to get familiar with design and my love for creativity.</p>
                        </div>
                     </li>
                     <!-- Single Experience -->
                     <li>
                        <div class="timeline_content">
                        <span>2020-2022</span>
                           <h4>Boston Private School</h4>
                           <p>Boston Private School is where I spent the last 2 years of my schooling career. This happened
                        during covid and is where I got to understand the importance of technology.</p>
                        </div>
                     </li>
                     <!-- Single Experience -->
                     <li>
